...
public class GetAllBookTourResponse {
	...
	public static GetAllBookTourResponse copy(BookTourDTO booktourDTO) {
		GetAllBookTourResponse result = new GetAllBookTourResponse();
